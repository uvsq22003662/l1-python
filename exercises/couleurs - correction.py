...
def draw_pixel(i, j, color):
    ...
    # Par défaut les rectangles ont une bordure de 1px noire. Un rectangle de 1 pixel 
    # de large ne se verra donc pas. Mettre width=0 pour supprimer la bordure.
...
def degrade_gris():
    ...
    for x in range(0, CANVAS_WIDTH):
        for y in range(0, CANVAS_HEIGHT):
            ...
            # Il faudrait modifier le code s'il fallait l'adapter à des
